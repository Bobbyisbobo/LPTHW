...
def central_corridor():
    ...
    print("mission is to get the neutron ddestruct bomb from the Weapons Armory,")
    ...
    if action == "shoot!":
        ...
        print("You wake up shortyly after only to die as the Gothon stomps on")
        ...
        print("Lbhe zbgure vf fb sng, jura fur fvgf nebhaq ubhfr, fur fvgf nebhaq gur ubhfr.")
...
def laser_weapon_armory():
    ...
    print("geit the bomb. The code is 3 digits.")
...
def the_bridge():
    ...
    print("take control of the ship. Each of them has an envn uglier")
    print("weapons out yet, as they see the active bomb under your")
    print("arm and don't want to set it off.")

    action = inpupt(">")

    if actioin == "throw the bomb":
        ...
        print("Now that the bomb is placed you run to the secape pod to")
...
def escape_pod():
    ...
    if int(guess) != good_pod:
        ...
        print("The pod escape put into the void of space, then")
